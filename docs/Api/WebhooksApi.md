...
> \OpenAPI\Client\Model\InlineResponse2004 webhooksIdUserGet($id_user)
...
> \OpenAPI\Client\Model\InlineResponse201 webhooksIdUserWebhookDelete($id_user, $webhook)
...
> \OpenAPI\Client\Model\InlineResponse201 webhooksIdUserWebhookPut($id_user, $webhook, $inline_object)
...
> \OpenAPI\Client\Model\InlineResponse201 webhooksPost($request_body_webhook)
...
$request_body_webhook = new \OpenAPI\Client\Model\RequestBodyWebhook(); // \OpenAPI\Client\Model\RequestBodyWebhook | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request_body_webhook** | [**\OpenAPI\Client\Model\RequestBodyWebhook**](../Model/RequestBodyWebhook.md)|  | [optional]
