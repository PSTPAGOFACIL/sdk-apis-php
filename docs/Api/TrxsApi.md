...
> \OpenAPI\Client\Model\ResponseBodyGetTrx trxsIdGet($id)
...
$apiInstance = new OpenAPI\Client\Api\TrxsApi(
...
[**\OpenAPI\Client\Model\ResponseBodyGetTrx**](../Model/ResponseBodyGetTrx.md)
...
> \OpenAPI\Client\Model\InlineResponse2002 trxsIdTrxNullificationGet($id_trx)
...
> \OpenAPI\Client\Model\ResponseBodyNullification trxsIdTrxNullificationPost($id_trx, $request_body_nullification)
...
$id_trx = 3.4; // float | 
$request_body_nullification = new \OpenAPI\Client\Model\RequestBodyNullification(); // \OpenAPI\Client\Model\RequestBodyNullification | 
...
------------- | ------------- | ------------- | -------------
 **id_trx** | **float**|  |
 **request_body_nullification** | [**\OpenAPI\Client\Model\RequestBodyNullification**](../Model/RequestBodyNullification.md)|  | [optional]

### Return type

[**\OpenAPI\Client\Model\ResponseBodyNullification**](../Model/ResponseBodyNullification.md)
...
> \OpenAPI\Client\Model\InlineResponse2003 trxsIdTrxNullificationStatusGet($id_trx, $verification_token)
...
> \OpenAPI\Client\Model\InlineResponse2001 trxsPost($request_body_trx)
...
$request_body_trx = new \OpenAPI\Client\Model\RequestBodyTrx(); // \OpenAPI\Client\Model\RequestBodyTrx | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request_body_trx** | [**\OpenAPI\Client\Model\RequestBodyTrx**](../Model/RequestBodyTrx.md)|  | [optional]
