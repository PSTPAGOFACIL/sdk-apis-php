...
class AuthApi
{
     ...
     *
     * @param  \Swagger\Client\Model\LoginBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\LoginResponse
     */
    public function usersLoginPost($body = null)
    {
        list($response) = $this->usersLoginPostWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function usersLoginPostAsync($body = null)
    {
        return $this->usersLoginPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersLoginPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\LoginResponse';
        $request = $this->usersLoginPostRequest($body);
     ...
     */
    protected function usersLoginPostRequest($body = null)
    {
